...
- [ ] T014：GPU TinyCNN 学习能力评估（`in_progress`；蒸馏 FP32/PTQ/QAT 为 `24/30`、`22/30`、`23/30`，teacher `30/30`，结论保持 `tune`）
...
- T014 baseline 与蒸馏 pilot 已完成：固定 split 的 3-seed FP32 validation MAE 为 `0.127903 +/- 0.000432`，gripper sign accuracy 为 `0.925218 +/- 0.001191`；同一批 30 episodes 的 baseline FP32/PTQ/QAT 为 `22/30`、`18/30`、`19/30`，蒸馏后为 `24/30`、`22/30`、`23/30`，teacher 为 `30/30`。蒸馏 FP32 validation MAE `0.126056`，teacher-action MAE 从 `0.103029` 降到 `0.077485`；结论保持 `tune`，仍需扩大闭环样本并生成最终 FPGA 参数包，详见 `docs/evaluation/t014_gpu_tinycnn_pilot.md`。
